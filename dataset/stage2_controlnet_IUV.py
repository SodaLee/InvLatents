...
class BaseDataset(TsvCondImgCompositeDataset):
    ...
    def get_metadata(self, idx):
        ...
        meta_data['densepose_img'] = self.get_densepose(img_idx)
    ...
    def __getitem__(self, idx):
        ...
        img = raw_data['img']
        skeleton_img = raw_data['densepose_img']
        keypoint_img = raw_data['pose_img']
        ...
        keypoint_img = self.augmentation(keypoint_img, self.cond_transform, state)
        full_pose_img = torch.cat([keypoint_img, skeleton_img], dim = 0)
        ...
        outputs = {'img_key':img_key,
                   'input_text': caption,
                   'label_imgs': img,
                   'cond_imgs': skeleton_img,
                   'full_pose_imgs': full_pose_img,
                   'reference_img': reference_img,
                   'reference_img_controlnet':reference_img_controlnet,
                   'reference_img_vae':reference_img_vae}
        if self.args.combine_use_mask:
