...
deepspeed --include localhost:4,5,6,7 finetune_sdm_yaml.py \
...
--log_dir logs/tiktok_posecombine_try0 \
--epochs 20 --deepspeed \
...
--pretrained_model /data1/lihaochen/DisCo_run/logs/tiktok_stage2_try0/last.pth/mp_rank_00_model_states.pt \
--guidance_scale 1.5