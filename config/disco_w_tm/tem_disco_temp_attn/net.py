...
class TemConvNet(Net):
    ...
    def forward_train_multicontrol(self, inputs, outputs):
        ...
        # ref_noise_single = self.gen_ref_noise(ref_image, None, image_seq.shape[-2], image_seq.shape[-1])
        # ref_noise = ref_noise_single.unsqueeze(2).repeat(1, 1, self.args.nframes, 1, 1)
